...
export const MOCK_REGISTER_MAP: RegisterDef[] = [
	...
	{ name: "AverageCurrent",        access: "Read", value_type: "SignedWord",  fields: [] },
	{ name: "ChargingCurrent",       access: "Read", value_type: "Word",       fields: [] },
	{ name: "AtRate",                access: "ReadWrite", value_type: "SignedWord", fields: [] },
	{ name: "Temperature",           access: "Read", value_type: "Word",       fields: [] },
	{ name: "RemainingCapacity",     access: "Read", value_type: "Word",       fields: [] },
	{ name: "FullChargeCapacity",    access: "Read", value_type: "Word",       fields: [] },
	{ name: "DesignCapacity",        access: "Read", value_type: "Word",       fields: [] },
	{ name: "RunTimeToEmpty",        access: "Read", value_type: "Word",       fields: [] },
	{ name: "AverageTimeToEmpty",    access: "Read", value_type: "Word",       fields: [] },
	{ name: "AverageTimeToFull",     access: "Read", value_type: "Word",       fields: [] },
	{ name: "RelativeStateOfCharge", access: "Read", value_type: "Word",       fields: [] },
	{ name: "AbsoluteStateOfCharge", access: "Read", value_type: "Word",       fields: [] },
