...
const SAMPLE_LOGS: LogEntry[] = [
	{ id: "1", timestamp: new Date("2025-01-01T10:00:00.123Z"), severity: "info", message: "Test started" },
	{ id: "2", timestamp: new Date("2025-01-01T10:00:01.456Z"), severity: "warn", message: "Voltage low" },
	{ id: "3", timestamp: new Date("2025-01-01T10:00:02.789Z"), severity: "error", message: "FAIL — over temp" },
];
