...
import { type RegisterEntry, RegisterTable } from "@/components/RegisterTable";
import { ActiveRegistersProvider } from "@/contexts/ActiveRegistersContext";

// ── Pack-level sub-groups ────────────────────────────────────────────────────
        ...
        <ActiveRegistersProvider>
            <Accordion multiple variant="separated" defaultValue={DEFAULT_OPEN}>
                ...
                <Accordion.Item value="pack-readings">
                    ...
                    <Accordion.Panel>
                        <Grid>
                            {Object.entries(PACK_GROUPS).map(
                                ([title, names]) => (
                                    <Grid.Col key={title} span={6}>
                                        <RegisterTable
                                            title={title}
                                            entries={toEntries(names)}
                                        />
                                    </Grid.Col>
                                ),
                            )}
                ...
                <Accordion.Item value="cell-temperatures">
                    ...
                    <Accordion.Panel>
                        <RegisterTable
                            ...
                            entries={toEntries(["CellTemperature"])}
                        />
                    </Accordion.Panel>
                </Accordion.Item>
                    ...
                    <Accordion.Panel>
                        <Grid>
                            <Grid.Col span={4}>
                                <RegisterTable
                                    title="Cell SoC"
                                    entries={toEntries(["CellSoC"])}
                                />
                            </Grid.Col>
                            <Grid.Col span={4}>
                                <RegisterTable
                                    title="Cell SoH"
                                    entries={toEntries(["CellSoH"])}
                                />
                            </Grid.Col>
                            <Grid.Col span={4}>
                                <RegisterTable
                ...
                <Accordion.Item value="charging">
                    ...
                    <Accordion.Panel>
                        <RegisterTable
                            title="Charging"
                            entries={toEntries(CHARGING_REGISTERS)}
                        />
                    </Accordion.Panel>
                </Accordion.Item>
                ...
                <Accordion.Item value="design-spec">
                    ...
                    <Accordion.Panel>
                        <RegisterTable
                            title="Design & Spec"
                            entries={toEntries(DESIGN_REGISTERS)}
                        />
                    </Accordion.Panel>
                </Accordion.Item>
                ...
                <Accordion.Item value="device-identity">
                    ...
                    <Accordion.Panel>
                        <RegisterTable
                            ...
                            entries={toEntries(IDENTITY_REGISTERS)}
                        />
                    </Accordion.Panel>
                </Accordion.Item>
                ...
                <Accordion.Item value="protection-settings">
                    ...
                    <Accordion.Panel>
                        <RegisterTable
                            ...
                            entries={toEntries(PROTECTION_REGISTERS)}
                        />
                    </Accordion.Panel>
                </Accordion.Item>
                    ...
                    <Accordion.Panel>
                        <Grid>
                            ...
                            <Grid.Col span={6}>
                                <RegisterTable
                                    title="Settings"
                                    entries={toEntries(CONFIG_VALUE_REGISTERS)}
                                />
                            </Grid.Col>
                        </Grid>
                    </Accordion.Panel>
                ...
                <Accordion.Item value="faults">
                    ...
                    <Accordion.Panel>
                        <RegisterTable
                            ...
                            entries={toEntries(FAULT_REGISTERS)}
                        />
                    </Accordion.Panel>
                </Accordion.Item>
                ...
                <Accordion.Item value="calibration">
                    ...
                    <Accordion.Panel>
                        <RegisterTable
                            title="Calibration"
                            entries={toEntries(CALIBRATION_REGISTERS)}
                        />
                    </Accordion.Panel>
                </Accordion.Item>
            </Accordion>
